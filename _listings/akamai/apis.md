...
- name: Akamai API Get a Property
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/domains/master/_listings/akamai/config-gtm-v1-domains-domain-properties-propertyname-get.md
x-common:
- type: x-base
