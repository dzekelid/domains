...
- name: Twilio
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/domains/master/_listings/twilio/accounts-accountsid-sip-domains-sipdomainsid-ipaccesscontrollistmappings-alsid-delete.md
x-common:
- type: x-net-library
